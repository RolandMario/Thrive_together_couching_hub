            ...
            {bookingStatus === 'processing' ? (
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-gray-600 mb-6 max-w-md">
                  Thank you, <strong>{formData.name}</strong>. We have sent a confirmation email to <strong>{formData.email}</strong> with details for your <strong>{selectedService?.title}</strong> on <strong>{selectedDate?.toLocaleDateString()} at {selectedTime}</strong>.
                </div>
                <button 
